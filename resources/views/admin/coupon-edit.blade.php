...
@section('content')
    <div class="page-header mb-4">
        <div class="d-flex justify-content-between align-items-center flex-wrap">
            <h4 class="fw-bold">Edit Coupon</h4>
            ...
            <div class="row align-items-center row-gap-4">
                ...
                <div class="col-md-8">
                    <input type="text" class="w-100 form-input" placeholder="Enter cart value" id="cvalue"
                        name="cvalue" value="{{ $coupon->cart_value }}">
                    @error('cvalue')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="col-md-8">
                    <input type="date" class="w-100 form-input" id="expdate" name="expdate" value="{{ $coupon->expiry_date }}">
                    @error('expdate')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
