...
@section('content')
    ...
    <div class="table-container rounded-3 p-3 w-100 mt-4 bg-white">
        <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-2">
            ...
            <a href="{{ route('admin.add-category') }}" class="add-btn">+ Add New</a>
        </div>
            ...
            <table class="w-100 table-bordered">
                ...
                @foreach ($categories as $category)
                    <tr>
                        ...
                        <td>2</td>
                        <td>
                            <a href="{{ route('admin.category-edit',['id'=>$category->id]) }}" class="text-success me-2"><i class="fa fa-pencil"></i></a>
                            <button class="text-danger bg-transparent" data-bs-toggle="modal" data-bs-target="#exampleModal"
                                data-bs-id="{{ $category->id }}"><i class="fa fa-trash-o"></i></button>
                        </td>
                    </tr>
                @endforeach
            </table>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <form action="{{ route('admin.category-delete', ['id' => 1]) }}" method="post" id="deleteForm">
                        @csrf
                        @method('DELETE')
...
<script>
    ...
    exampleModal.addEventListener('show.bs.modal', function (event) {
        ...
        form.action = '/admin/categories/delete/' + brandId;
    });
</script>
@endpush
